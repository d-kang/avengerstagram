...
var filteredSampleData = sampleData.data.filter(function(a) { return !a.thumbnail.path.includes('image_not') && a.thumbnail.extension !== 'gif'})

module.exports = filteredSampleData;
